...
void setup() {
  ...
  BLE.scanForUuid("00000002-0000-1000-8000-2f97f3b2dcd5");
}
...
void controlLed(BLEDevice peripheral) {
  ...
  BLECharacteristic ledCharacteristic = peripheral.characteristic("EBAFB2F0-0E0F-40A2-A84F-E2F098DC13C3");
